...
const crypto = () => {
  return (
    <>
    <Head>
      <title>Ton | BlackHat Jit LP</title>
    </Head>
      <div className="w-full">
        ...
        <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
          <div className="col-span-4">
            ...
            <h2>Overview</h2>
            <p>
              This page is the latest Landing Page I &apos;ve done with Jit
              using Webflow and Hubspot.
            </p>
            <a
              href="https://www.jit.io/blackhat/blackhat-2023-jit"
              target="_blank"
              rel="noreferrer"
            >
